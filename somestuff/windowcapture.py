...
class WindowCapture:
    ...
    def click_on_certain_position(self,pos):
    ...
    def get_relative_mouse_coordinates(self):
        window_rect = win32gui.GetWindowRect(self.hwnd)
        tempt = win32api.GetCursorPos()
        x = tempt[0]-window_rect[0] # Calculate the relative x coordinate
        y = tempt[1]-window_rect[1] 
        return (x,y)